# CleanAir 
**STM32 F446RE AC Motor Dimming & Multi by Sensors** 
...
## Design & Purpose
The project based on a knowledge and experience i made in ESP-IDF, therefor I did not see the logic of use AI to create the message loop & the BME sensor code.
